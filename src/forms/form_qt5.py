...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "Separate by"))
        self.separatorFieldRadioButton.setText(_translate("Dialog", "Separator field"))
        self.numberOfCardsRadioButton.setText(_translate("Dialog", "Number of notes"))
